...
function display(x) {
  let mynewarray = x.map(function(value, index) {
    ...
    const display = `
    <div class="movieCard col-xl-4 col-lg-6">
    <div class="wrapImage">
...
<div class="Overlay">
<p><span>Director:</span>  ${value.Director} </p>
<p><span>Writer:</span> ${value.Writer}</p>
<p><span>Actor:</span>  ${value.Actors}</p>
</div>
</div>
<h5>${value.Title} (${value.Year})</h5>
<p>${value.Language}</p>
</div>`;
